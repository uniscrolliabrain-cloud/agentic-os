# 015/100 - FASE 2.5 — ENTIDADES CONTENT / COACHING / THERAPY
...
## PROMPT PARA CLINE
```text
# TAREA 015/100 - FASE 2.5 — ENTIDADES CONTENT / COACHING / THERAPY
...
## TU TAREA ESPECÍFICA
FASE 2.5 — ENTIDADES CONTENT / COACHING / THERAPY

Consolida las entidades físicas restantes especificadas en el documento.

Como mínimo:

- content.blog_post
- coaching.client
- coaching.session_note
- therapy.client
- therapy.appointment

Si el repositorio utiliza PatientSession en lugar de estas clases, NO lo sustituyas ciegamente: inspecciona sus dependencias y realiza la migración compatible.
...
- extra="forbid";
- inmutabilidad;
- timestamps mediante now_utc() cuando corresponda.

Presta especial atención a campos sensibles como notes_private.
