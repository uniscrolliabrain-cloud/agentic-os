# 028/100 - FASE 3.8 — COMPILADOR PRINCIPAL
...
## PROMPT PARA CLINE
```text
# TAREA 028/100 - FASE 3.8 — COMPILADOR PRINCIPAL
...
## TU TAREA ESPECÍFICA
FASE 3.8 — COMPILADOR PRINCIPAL

Implementa/consolida SemanticCompiler.compile().
...
Si no hay candidatos → clarification.

Si confianza insuficiente → clarification.

Si cristalización falla → clarification.

Nunca ejecutar connector.

El execution_graph debe estar limitado a referencias canónicas existentes en catálogo.

Añade tests end-to-end con MockLLMProvider.
