# 046/100 - FASE 5.6 — POLICY ENGINE
...
## PROMPT PARA CLINE
```text
# TAREA 046/100 - FASE 5.6 — POLICY ENGINE
...
## TU TAREA ESPECÍFICA
FASE 5.6 — POLICY ENGINE

Consolida PolicyEngine.
...
Un tenant inexistente debe ser DENY.

Una capability no habilitada debe ser DENY.

Una policy corrupta debe provocar DENY.

No permitas wildcard allow en producción.

DEV_ALLOW_ALL debe quedar explícitamente limitado al entorno de desarrollo/sandbox.
