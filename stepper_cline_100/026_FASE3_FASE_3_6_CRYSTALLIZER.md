...
## PROMPT PARA CLINE
```text
# TAREA 026/100 - FASE 3.6 — CRYSTALLIZER
...
## TU TAREA ESPECÍFICA
FASE 3.6 — CRYSTALLIZER

Implementa/consolida crystallizer.py.
...
Debe generar JSON estructurado mediante ModelRouter y validarlo contra el modelo Pydantic.

La respuesta válida debe ser un modelo Pydantic, no un dict arbitrario validado superficialmente.

El schema debe proceder de:

contract_cls.model_json_schema()

No permitas que el LLM modifique el schema.

Añade tests usando MockLLMProvider.
