# 071/100 - FASE 8.1 — EVENTLOG JSONL
...
## PROMPT PARA CLINE
```text
# TAREA 071/100 - FASE 8.1 — EVENTLOG JSONL
...
## TU TAREA ESPECÍFICA
FASE 8.1 — EVENTLOG JSONL

Consolida JsonlEventLog.
...
- utilizar lock;
- hacer flush/fsync;
- realizar replace atómico;
- fallar explícitamente si no puede persistir.

No devuelvas [] silenciosamente ante corrupción si eso puede ocultar una violación de integridad.
