# 013/100 - FASE 2.3 — ENTIDADES SALES
...
## PROMPT PARA CLINE
```text
# TAREA 013/100 - FASE 2.3 — ENTIDADES SALES
...
## TU TAREA ESPECÍFICA
FASE 2.3 — ENTIDADES SALES

Implementa y valida las entidades de ventas especificadas:

sales.lead
sales.proposal

Lead debe mantener restricciones de:
...
Proposal debe mantener:

- lead_id;
- value_proposition;
- pricing_model_offered;
- approval_required;
- sent_at;
- created_at.

No relajes validaciones para hacer pasar tests.

Añade tests positivos y negativos.

Comprueba que los kind Literal son exactamente los canónicos definidos.
