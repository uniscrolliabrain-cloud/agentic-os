# 073/100 - FASE 8.3 — EVENT INVARIANTS
...
## PROMPT PARA CLINE
```text
# TAREA 073/100 - FASE 8.3 — EVENT INVARIANTS
...
## TU TAREA ESPECÍFICA
FASE 8.3 — EVENT INVARIANTS

Implementa invariantes ejecutables en:

kernel/world/invariants.py
...
INVARIANTS = ["Event immutable"]

Las reglas deben ejecutarse físicamente.
