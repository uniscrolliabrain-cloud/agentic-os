...
## PROMPT PARA CLINE
```text
# TAREA 084/100 - FASE 9.4 — TASK STATE
...
Consolida _background_tasks/TaskStore.
...
debe estar representado correctamente en el contrato.

El estado debe aislarse por tenant.

No dependas únicamente de un dict global si la arquitectura ya tiene TaskStore.
