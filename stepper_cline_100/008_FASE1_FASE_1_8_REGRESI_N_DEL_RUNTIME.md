# 008/100 - FASE 1.8 — REGRESIÓN DEL RUNTIME
...
## PROMPT PARA CLINE
```text
# TAREA 008/100 - FASE 1.8 — REGRESIÓN DEL RUNTIME
...
## TU TAREA ESPECÍFICA
FASE 1.8 — REGRESIÓN DEL RUNTIME

Crea una suite de tests específica para los cambios de FASE 1.

Debe cubrir como mínimo:

- PipelineRunner obligatorio;
- ausencia de bypass;
- ejecución mediante Executor;
- reloj canónico;
- fallo del EventLog;
- propagación de tenant_id;
- propagación de correlation_id;
- propagación de command_id;
- comportamiento del Scheduler.

Utiliza mocks/fakes controlados para connectors y persistencia.

Los tests no deben necesitar APIs externas reales.

Ejecuta:

pytest tests/

Si fallan tests antiguos, corrige las regresiones provocadas por esta fase antes de continuar.

No tapes fallos mediante skips.
