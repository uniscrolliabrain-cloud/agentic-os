# 080/100 - FASE 8.10 — GATE EVENT SOURCING
...
## PROMPT PARA CLINE
```text
# TAREA 080/100 - FASE 8.10 — GATE EVENT SOURCING
...
## TU TAREA ESPECÍFICA
FASE 8.10 — GATE EVENT SOURCING

Verifica:

- EventLog persistente;
- AuditLog persistente;
- atomicidad;
- fsync;
- tenant isolation;
- invariants ejecutables;
- RateLimiter correcto;
- API execute cerrada;
- fail-closed.

Ejecuta tests completos.

Declara PASS/FAIL y no continúes con fallos críticos.
