# 041/100 - FASE 5.1 — TENANT BOUNDARY AUDIT
...
## PROMPT PARA CLINE
```text
# TAREA 041/100 - FASE 5.1 — TENANT BOUNDARY AUDIT
...
## TU TAREA ESPECÍFICA
FASE 5.1 — TENANT BOUNDARY AUDIT

Audita todo el sistema para localizar dónde se obtiene tenant_id.

Debe existir una única autoridad de contexto por request.

Busca:

- X-Tenant-Id;
- tenant_id de JWT;
- tenant_id de API key;
- valores default;
- "system";
- "default";
- acceso a data/tenants;
- policies;
- EventLog.

Identifica cualquier posibilidad de que el usuario A solicite recursos del tenant B.

No implementes todavía JWT.
Entrega primero el mapa de amenazas y los puntos de enforcement.
