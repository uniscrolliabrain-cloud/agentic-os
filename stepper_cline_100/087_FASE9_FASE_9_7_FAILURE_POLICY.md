# 087/100 - FASE 9.7 — FAILURE POLICY
...
## PROMPT PARA CLINE
```text
# TAREA 087/100 - FASE 9.7 — FAILURE POLICY
...
Las acciones deben estar cerradas.

No permitas que el LLM invente una nueva acción.

Los retries deben respetar:
