# 031/100 - FASE 4.1 — PROVIDER REGISTRY
FASE 4 - MODEL MESH
Estado: - [ ] PENDIENTE
...
## PROMPT PARA CLINE
```text
# TAREA 031/100 - FASE 4.1 — PROVIDER REGISTRY
...
## TU TAREA ESPECÍFICA
FASE 4.1 — PROVIDER REGISTRY

Inspecciona interfaces/llm y connectors relacionados con LLM.
...
- GroqProvider;
- MockLLMProvider;
- cualquier provider adicional;
- settings;
- RateLimiter.

No dupliques providers existentes.

Define la frontera:

Provider = inferencia.
Router = selección/orquestación.
Crystallizer = validación contractual.

Entrega primero un inventario y después implementa solo las consolidaciones necesarias.
