# 085/100 - FASE 9.5 — EXECUTION PLAN
...
## PROMPT PARA CLINE
```text
# TAREA 085/100 - FASE 9.5 — EXECUTION PLAN
...
## TU TAREA ESPECÍFICA
FASE 9.5 — EXECUTION PLAN

El Orchestrator debe recibir un plan previamente compilado.

No debe reinterpretar libremente el texto del usuario.
...
execution_graph → ejecución arbitraria.

Añade tests de plan válido/inválido.
