...
## PROMPT PARA CLINE
```text
# TAREA 066/100 - FASE 7.6 — HUBSPOT
...
Consolida HubSpotConnector.

Debe soportar únicamente:

crm.contact.create
crm.contact.read
crm.contact.update

Normaliza respuestas a CanonicalContact.

Valida email y parámetros antes de red.

Implementa refresh mediante TokenManager/OAuthManager.

No guardes raw response con secretos.

Añade tests mockeando HTTPX.
