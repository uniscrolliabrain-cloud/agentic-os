...
## PROMPT PARA CLINE
```text
# TAREA 039/100 - FASE 4.9 — SETTINGS
...
Las claves deben proceder de configuración segura/.env y no del código fuente.

No introduzcas secretos por defecto.

Si no hay claves:

- tests pueden utilizar Mock;
- producción debe quedar explícitamente identificada como no configurada.

Añade .env.example si corresponde, sin valores secretos.
