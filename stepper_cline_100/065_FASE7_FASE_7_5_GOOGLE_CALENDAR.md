# 065/100 - FASE 7.5 — GOOGLE CALENDAR
...
## PROMPT PARA CLINE
```text
# TAREA 065/100 - FASE 7.5 — GOOGLE CALENDAR
...
## TU TAREA ESPECÍFICA
FASE 7.5 — GOOGLE CALENDAR

Implementa/consolida calendar.event.create.
...
No confíes en strings arbitrarios sin validación.

La operación debe respetar ExecutionMode/RiskLevel/Policy.

Una acción de creación real no debe saltarse el Executor.
