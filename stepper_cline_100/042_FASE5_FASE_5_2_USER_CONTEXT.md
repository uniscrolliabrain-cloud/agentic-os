...
## PROMPT PARA CLINE
```text
# TAREA 042/100 - FASE 5.2 — USER CONTEXT
...
## TU TAREA ESPECÍFICA
FASE 5.2 — USER CONTEXT

Consolida:

src/agentic_os/identity/models.py

UserContext debe representar de forma tipada:

- usuario;
- tenant_id;
- roles;
- identidad/autorización relevante.

Debe ser Pydantic v2.

No permitas que rutas REST utilicen directamente headers como autoridad de autorización después de haber construido UserContext.
