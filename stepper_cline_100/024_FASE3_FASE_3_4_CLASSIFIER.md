...
## PROMPT PARA CLINE
```text
# TAREA 024/100 - FASE 3.4 — CLASSIFIER
...
Implementa el Classifier determinista.

Debe:

- normalizar texto;
- utilizar vocabulario/taxonomía;
- buscar términos y sinónimos;
- devolver IntentMatch;
- ordenar candidatos por confianza;
- NO llamar ningún LLM.

No hardcodees una segunda taxonomía paralela si DEFAULT_VOCAB o KernelCatalog ya existe.

Las intenciones del documento incluyen ejemplos como:
...
pero debes comprobar qué catálogo real existe en el repositorio antes de registrarlas.

Añade tests en español y con variantes semánticas.
