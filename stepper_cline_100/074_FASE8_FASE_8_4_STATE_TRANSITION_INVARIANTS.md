# 074/100 - FASE 8.4 — STATE TRANSITION INVARIANTS
...
## PROMPT PARA CLINE
```text
# TAREA 074/100 - FASE 8.4 — STATE TRANSITION INVARIANTS
...
## TU TAREA ESPECÍFICA
FASE 8.4 — STATE TRANSITION INVARIANTS

Implementa:

assert_transition_valid(current_state, event)

Debe detectar como mínimo:

- entity_created duplicado;
- update inexistente;
- delete inexistente cuando corresponda;
- transiciones incompatibles.

Integra estas invariantes en el punto correcto del Applier/replay.

No las dejes como funciones nunca llamadas.
