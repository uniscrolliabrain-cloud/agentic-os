# 089/100 - FASE 9.9 — E2E SIN RED REAL
...
## PROMPT PARA CLINE
```text
# TAREA 089/100 - FASE 9.9 — E2E SIN RED REAL
...
## TU TAREA ESPECÍFICA
FASE 9.9 — E2E SIN RED REAL

Construye una prueba end-to-end:
...
- tenant se conserva;
- correlation_id se conserva;
- command_id se conserva;
- policy se aplica;
- auditoría se genera;
- resultado vuelve al task.
