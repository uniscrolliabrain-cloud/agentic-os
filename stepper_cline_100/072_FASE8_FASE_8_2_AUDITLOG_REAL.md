# 072/100 - FASE 8.2 — AUDITLOG REAL
...
## PROMPT PARA CLINE
```text
# TAREA 072/100 - FASE 8.2 — AUDITLOG REAL
...
## TU TAREA ESPECÍFICA
FASE 8.2 — AUDITLOG REAL

Consolida:

src/agentic_os/connectors/core/audit.py

AuditRecord debe ser Pydantic.

AuditLog.record() debe persistir realmente.

No debe limitarse a self._records.

El almacenamiento debe quedar aislado por tenant.

Un fallo físico de escritura debe propagarse como error duro cuando la auditoría sea obligatoria.

Añade tests de persistencia y fallo.
