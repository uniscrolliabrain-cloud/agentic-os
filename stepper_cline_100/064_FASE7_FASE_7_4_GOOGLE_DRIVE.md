...
## PROMPT PARA CLINE
```text
# TAREA 064/100 - FASE 7.4 — GOOGLE DRIVE
...
## TU TAREA ESPECÍFICA
FASE 7.4 — GOOGLE DRIVE

Implementa/consolida file.read.

Valida file_id.

No permitas que file_id se convierta en path local.

Obtén metadata y contenido mediante Google API.

El contenido debe respetar el tipo MIME.

No asumas que todos los archivos son UTF-8.

Si el resultado es binario, conserva representación segura.
