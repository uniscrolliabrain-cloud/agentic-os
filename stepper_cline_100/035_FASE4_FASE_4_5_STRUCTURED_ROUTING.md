# 035/100 - FASE 4.5 — STRUCTURED ROUTING
FASE 4 - MODEL MESH
Estado: - [ ] PENDIENTE
...
## PROMPT PARA CLINE
```text
# TAREA 035/100 - FASE 4.5 — STRUCTURED ROUTING
...
## TU TAREA ESPECÍFICA
FASE 4.5 — STRUCTURED ROUTING

Implementa route_structured().
...
El resultado debe validarse físicamente contra Pydantic.

No basta con json.loads().

Si el provider devuelve JSON sintácticamente correcto pero incompatible con el schema, debe considerarse fallo.

Añade tests con:

- JSON válido;
- JSON válido pero schema inválido;
- respuesta corrupta;
- provider failure.
