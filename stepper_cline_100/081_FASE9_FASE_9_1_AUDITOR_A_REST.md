# 081/100 - FASE 9.1 — AUDITORÍA REST
...
## PROMPT PARA CLINE
```text
# TAREA 081/100 - FASE 9.1 — AUDITORÍA REST
...
## TU TAREA ESPECÍFICA
FASE 9.1 — AUDITORÍA REST

Audita rest.py completo.
...
Comprueba que cada endpoint utiliza la dependencia correcta.
