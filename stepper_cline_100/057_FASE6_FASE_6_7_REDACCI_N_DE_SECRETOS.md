# 057/100 - FASE 6.7 — REDACCIÓN DE SECRETOS
...
## PROMPT PARA CLINE
```text
# TAREA 057/100 - FASE 6.7 — REDACCIÓN DE SECRETOS
...
## TU TAREA ESPECÍFICA
FASE 6.7 — REDACCIÓN DE SECRETOS

Audita logging y excepciones.
...
Busca str(exception), logger.error(), payloads y model_dump().

Implementa redacción donde sea necesaria.

Añade tests que comprueben que los logs no contienen secretos simulados.
