# 056/100 - FASE 6.6 — INYECCIÓN DEL TOKEN MANAGER
...
## PROMPT PARA CLINE
```text
# TAREA 056/100 - FASE 6.6 — INYECCIÓN DEL TOKEN MANAGER
...
## TU TAREA ESPECÍFICA
FASE 6.6 — INYECCIÓN DEL TOKEN MANAGER

Integra TokenManager en los connectors que utilizan OAuth.

Antes de una llamada real:

credentials
→ comprobar vigencia
→ refresh si necesario
→ ejecutar API.

No dupliques lógica de refresh diferente en cada connector.

Si GoogleConnector ya utiliza directamente creds.refresh(), evalúa si eso rompe la abstracción TokenManager y consolídalo.
