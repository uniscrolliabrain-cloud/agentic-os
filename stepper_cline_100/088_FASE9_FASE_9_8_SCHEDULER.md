...
## PROMPT PARA CLINE
```text
# TAREA 088/100 - FASE 9.8 — SCHEDULER
...
- cargar pipeline;
- validar policy;
- ejecutar mediante PipelineRunner/Executor;
- persistir auditoría;
- fallar closed si la auditoría obligatoria falla.

No debe ejecutar funciones arbitrarias configuradas por texto.
