# 048/100 - FASE 5.8 — AUTORIZACIÓN POR USERCONTEXT
...
## PROMPT PARA CLINE
```text
# TAREA 048/100 - FASE 5.8 — AUTORIZACIÓN POR USERCONTEXT
...
## TU TAREA ESPECÍFICA
FASE 5.8 — AUTORIZACIÓN POR USERCONTEXT

Implementa/consolida:

PolicyEngine.can_for_user()
...
desde UserContext validado.

No permitas que el llamador pase un tenant_id distinto al del UserContext para conseguir acceso.

Comprueba también que el usuario no pueda modificar sus propios roles mediante input externo.

Añade tests de tenant mismatch.
