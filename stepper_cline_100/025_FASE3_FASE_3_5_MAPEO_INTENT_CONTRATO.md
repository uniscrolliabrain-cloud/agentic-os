# 025/100 - FASE 3.5 — MAPEO INTENT → CONTRATO
...
## PROMPT PARA CLINE
```text
# TAREA 025/100 - FASE 3.5 — MAPEO INTENT → CONTRATO
...
## TU TAREA ESPECÍFICA
FASE 3.5 — MAPEO INTENT → CONTRATO

Implementa el registro/mapeo entre intents y modelos Pydantic de entrada.

El mapeo debe ser explícito.

No utilices:

contracts.get(intent, BaseModel)

como fallback permisivo para intenciones desconocidas.

Una intención desconocida debe provocar:

- ausencia de ejecución;
- clarificación o error contractual controlado.

Comprueba que cada intent registrado tiene un modelo físico.
