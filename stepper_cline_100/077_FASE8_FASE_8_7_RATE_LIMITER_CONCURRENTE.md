# 077/100 - FASE 8.7 — RATE LIMITER CONCURRENTE
...
## PROMPT PARA CLINE
```text
# TAREA 077/100 - FASE 8.7 — RATE LIMITER CONCURRENTE
...
## TU TAREA ESPECÍFICA
FASE 8.7 — RATE LIMITER CONCURRENTE

Prueba RateLimiter bajo concurrencia.

Debe evitar que dos threads pasen simultáneamente cuando el límite ya se alcanzó.

Mantén RLock o mecanismo equivalente.

Añade tests concurrentes.

No optimices prematuramente eliminando locks.
