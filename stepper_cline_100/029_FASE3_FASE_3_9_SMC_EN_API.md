...
## PROMPT PARA CLINE
```text
# TAREA 029/100 - FASE 3.9 — SMC EN API
...
Integra SemanticCompiler en:

src/agentic_os/interfaces/api/rest.py

El flujo de /api/chat debe conservar la separación:

Laia/Front Assistant
→ respuesta rápida al usuario

SMC
→ compilación semántica

Orchestrator
→ ejecución del plan

No permitas que el orquestador escriba directamente mensajes internos en el historial del usuario.

Elimina/evita prefijos de back-office como mecanismo de comunicación UX.

El estado de procesamiento debe consultarse mediante TaskStore/EventLog/background task según la infraestructura real.
