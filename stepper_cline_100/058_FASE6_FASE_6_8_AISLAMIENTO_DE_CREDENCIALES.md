# 058/100 - FASE 6.8 — AISLAMIENTO DE CREDENCIALES
...
## PROMPT PARA CLINE
```text
# TAREA 058/100 - FASE 6.8 — AISLAMIENTO DE CREDENCIALES
...
## TU TAREA ESPECÍFICA
FASE 6.8 — AISLAMIENTO DE CREDENCIALES
...
La ruta física debe derivarse de identificadores validados.
...
Añade tests de path traversal y cross-tenant credential access.
