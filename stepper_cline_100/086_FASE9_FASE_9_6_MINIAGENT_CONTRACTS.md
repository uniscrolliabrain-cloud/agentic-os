# 086/100 - FASE 9.6 — MINIAGENT CONTRACTS
...
## PROMPT PARA CLINE
```text
# TAREA 086/100 - FASE 9.6 — MINIAGENT CONTRACTS
...
Los límites deben ser ejecutables, no documentación decorativa.
...
Añade tests donde cada límite sea excedido.
