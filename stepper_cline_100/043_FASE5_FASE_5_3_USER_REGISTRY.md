# 043/100 - FASE 5.3 — USER REGISTRY
...
## PROMPT PARA CLINE
```text
# TAREA 043/100 - FASE 5.3 — USER REGISTRY
...
## TU TAREA ESPECÍFICA
FASE 5.3 — USER REGISTRY

Implementa/consolida UserRegistry.

Debe:

- almacenar usuarios de forma controlada;
- usar bcrypt para passwords;
- verificar hashes;
- impedir almacenar passwords en claro;
- soportar usuarios activos/inactivos;
- aislar usuarios por tenant.

La persistencia debe ser atómica según la arquitectura del proyecto.

No registres passwords ni tokens en logs.
