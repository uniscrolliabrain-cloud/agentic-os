# 068/100 - FASE 7.8 — CONNECTOR ROUTER
...
## PROMPT PARA CLINE
```text
# TAREA 068/100 - FASE 7.8 — CONNECTOR ROUTER
...
## TU TAREA ESPECÍFICA
FASE 7.8 — CONNECTOR ROUTER

Audita ConnectorRouter.
...
No permitas que un usuario proporcione:

connector="arbitrary.module"

para cargar código dinámicamente.

El catálogo debe ser autoridad.

Una capability sin connector físico debe fallar de forma controlada.
