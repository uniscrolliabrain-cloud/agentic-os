# 075/100 - FASE 8.5 — POLICY INVARIANTS
...
## PROMPT PARA CLINE
```text
# TAREA 075/100 - FASE 8.5 — POLICY INVARIANTS
...
## TU TAREA ESPECÍFICA
FASE 8.5 — POLICY INVARIANTS

Implementa:

assert_policy_safety(policy)

Debe impedir:

- wildcard allow en producción;
- allow destructivo sin human approval cuando corresponda.

Determina cómo interactúa esta función con DEV_ALLOW_ALL.

No permitas que una variable de entorno convierta silenciosamente producción en allow-all.
