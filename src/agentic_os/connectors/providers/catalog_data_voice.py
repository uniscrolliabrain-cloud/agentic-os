...
PROVIDER_SPECS_DATA_VOICE: Dict[str, Dict[str, Any]] = {
    ...
    "supabase": {
        "connector_id": "supabase", "provider": "Supabase", "auth_type": "bearer",
        "caps": ["storage.file.upload", "storage.file.download", "storage.file.read",
                 "storage.file.delete", "storage.folder.create", "storage.folder.list",
                 "storage.bucket.create", "storage.bucket.list",
                 "auth.signin.email", "auth.signin.oauth", "auth.signout",
                 "auth.user.get", "auth.user.update", "auth.token.refresh",
                 "auth.jwt.verify",
                 "db.query", "db.record.create", "db.record.read",
                 "db.record.update", "db.record.delete", "db.schema.inspect"],
        "extra_env": ["SUPABASE_URL"],
